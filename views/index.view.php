...
<div class="container">
        ...
        <div class="col-5 mx-auto">
            ...
            <ul class="list">
               <?php foreach($tasks as $task):?>
                   ...
                   <li><span class="task-content"><?=$task['task']?></span>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                       ...
                       <form action="/edit" class="editForm form mt-3" id="<?=$task['id']?>">
        ...
        <div class="col-5 mx-auto border p-3 mt-5">
            <form action="/create" method="post" class="form ">
                ...
                <div class="input-group my-3">
                    ...
                    <input type="date" class="form-control" name="finish_date" id="date" placeholder="yyyy-mm-dd">
                </div>
